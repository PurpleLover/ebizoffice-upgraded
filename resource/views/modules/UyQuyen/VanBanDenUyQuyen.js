...
class VanBanDenUyQuyen extends Component {
    constructor(props) {
        super(props);
    ...
    onCheck(itemId) {
        ...
        this.setState({
            ...
            if (this.state.code === 'VANBANDEN_DOKHAN') {
                this.props.selectVanBanDenDoKhan(itemId);
            }
            else if (this.state.code === 'VANBANDEN_DOQUANTRONG') {
                this.props.selectVanBanDenDoMat(itemId);
            }
            else if (this.state.code === 'VANBANDEN_LINHVUCVANBAN') {
                this.props.selectVanBanDenLinhVucVanBan(itemId);
            }
            else {
                this.props.selectVanBanDenLoaiVanBan(itemId);
            }
        })
...
const mapDispatchToProps = (dispatch) => {
    return {
        selectVanBanDenDoKhan: (itemId) => dispatch(action.selectVanBanDenDoKhan(itemId)),
        selectVanBanDenDoMat: (itemId) => dispatch(action.selectVanBanDenDoMat(itemId)),
        selectVanBanDenLinhVucVanBan: (itemId) => dispatch(action.selectVanBanDenLinhVucVanBan(itemId)),
        selectVanBanDenLoaiVanBan: (itemId) => dispatch(action.selectVanBanDenLoaiVanBan(itemId)),
    }
}

export default connect(mapStateToProps, mapDispatchToProps)(VanBanDenUyQuyen);
